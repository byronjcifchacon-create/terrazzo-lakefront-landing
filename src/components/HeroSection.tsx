...
const HeroSection = () => {
  return (
    <section id="top" className="relative h-svh w-full overflow-hidden flex flex-col items-center justify-center bg-card">
      ...
      <div className="absolute top-8 right-8 z-30 flex gap-6">
        <a href="#" className="text-police-blue hover:opacity-70 transition-opacity" aria-label="Instagram">
        ...
        <a href="#" className="text-police-blue hover:opacity-70 transition-opacity" aria-label="Facebook">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative z-20 text-center px-6 w-full max-w-7xl mx-auto">
        <h1 className="serif text-police-blue text-5xl md:text-8xl mb-12 tracking-tight text-balance">
          Terrazzo <br />
